...
import main.java.Protocol.Request;
...
public class Client extends Application {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Correct usage: \"java -jar main.java.Client.jar <ip_address> <port_number>\"");
            System.exit(1);
        }
        launch(args);
    }
    ...
    public void start(Stage primaryStage) {
        ...
        connectToServer();
        primaryStage.setTitle("Stratego | main.java.Client.main.java.Client");
